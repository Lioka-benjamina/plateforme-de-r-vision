  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto mb-10 animate-fade-in">
      ...
      <nav className="flex items-center gap-1.5 text-xs text-surface-400">
        <Link to="/admin" className="hover:text-primary-600 transition-all">Admin</Link>
        <ChevronRight className="w-3 h-3" />
        <Link to="/admin/courses" className="hover:text-primary-600 transition-all">Cours</Link>
        <ChevronRight className="w-3 h-3" />
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-2xl p-6 flex flex-col sm:flex-row items-center gap-4">
          ...
          <div className="flex gap-3">
            <button onClick={handleReject} disabled={!!processing}
              className="flex items-center gap-2 px-4 py-2 bg-white border border-red-200 text-red-700 rounded-2xl text-sm font-semibold hover:bg-red-50 transition-all disabled:opacity-50 active:scale-[0.98]">
            ...
            <button onClick={handleApprove} disabled={!!processing}
              className="flex items-center gap-2 px-4 py-2 bg-emerald-600 text-white rounded-2xl text-sm font-semibold hover:bg-emerald-700 transition-all disabled:opacity-50 active:scale-[0.98]">
