        ...
        <div className="bg-white rounded-3xl shadow-card border border-surface-100/80 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-semibold text-surface-700 mb-2">Nom</label>
                <input
                  type="text"
                  value={nom}
              ...
              <div>
                <label className="block text-sm font-semibold text-surface-700 mb-2">Prénom</label>
                <input
                  type="text"
                  value={prenom}
